...
<a href='https://openhome.xyz/' target='_blank'>
    <img src='openhome_icons/intro.png' border='0' alt='OpenHome' width='250' height='250'/>
</a>
...
<b>Our Mission:</b> To build a Voice AI platform that's cutting edge, open, customizable, and versatile for every user. We're not just creating a product, we're creating an ecosystem where every idea counts and is integrated to one giant super brain.
