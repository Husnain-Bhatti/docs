...
description: 'The `CapabilityWorker` is a class designed to manage asynchronous input and output operations for abilities within the system. It handles tasks such as speaking responses, listening for user input, and managing user interaction loops.
'
---
...
The `CapabilityWorker` provides essential functionality for managing interactions within abilities, facilitating seamless communication between the user and the system.
