...
- Select the <img src="openhome_icons/dashboard_images/save_button.png" alt="save_button" width="100" height="30" style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} /> button to finalize and create the new Personality.
- If you change your mind, select the <img src="openhome_icons/dashboard_images/cancel_button.png" alt="cancel_button" width="100" height="30" style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} /> button to discard the process.
...
- <img src="openhome_icons/dashboard_images/reset_icon.png" alt="reset_icon" width="100" height="30" style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} /> **Reset Profile**: For installed personalities reset the personality to it’s default settings.
- <img src="openhome_icons/dashboard_images/rating_and_review.png" alt="rating_and_review" width="100" height="30" style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} /> **Ratings & Review**: Review and rate the personality on the marketplace.  
