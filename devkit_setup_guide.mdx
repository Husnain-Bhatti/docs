...
<p align="center">
  <img src="openhome_icons/pi_images/pi_imager.png" alt="pi_imager" width="500" height="500"/>
</p>

3. **OpenHome DevKit OS**:
   - You can download the OpenHome DevKit OS from [here](https://drive.google.com/drive/folders/1fSsxsAa0YksuFrVLRFtm4aIkZHAvvr4b?usp=sharing).
...
<p align="center">
  <img src="openhome_icons/pi_images/pi_imager_final.png" alt="pi_imager_final" width="500" height="500" />
</p>

   6. **instructions**:
      - Click on next button, you will see beloe screen, click on `No` and continue

<p align="center">
  <img src="openhome_icons/pi_images/no.png" alt="no" width="400" height="400" />
</p>
...
2. **Web Interface will automatically open if not you can perform the following**:
...
<p align="center">
  <img src="openhome_icons/pi_images/device_setup.png" alt="device_setup" width="500" height="500"/>
</p>
...
<p align="center">
  <img src="openhome_icons/pi_images/login.png" alt="login" width="500" height="500"/>
</p>

   - Once the configuration is done, you will see this status

<p align="center">
  <img src="openhome_icons/pi_images/success.png" alt="success" width="500" height="500"/>
</p>
...
<p align="center">
  <img src="openhome_icons/pi_images/mic_speaker.png" alt="mic_speaker" width="600" height="600"/>
</p>
