...
- <img src="openhome_icons/dashboard_icons/speaker.png" alt="Audio Button" width="40" height="40" style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} /> Toggles audio on or off. Use this if you don’t want to hear spoken responses.

- <img src="openhome_icons/dashboard_images/mic_button.png" alt="Microphone Button" width="40" height="40" style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} /> Mutes or unmutes your microphone, depending on your interaction preference.
...
The Personality Settings panel is located on the right side of the conversation window. This panel allows you to modify and update personality-related settings dynamically during a conversation. The settings include **Conversation Controls**, **Behavior Controls**, and **Identity Controls**.
<p align="center">
  <img src="openhome_icons/dashboard_icons/personality_settings.png" alt="personality_settings" />
</p>


### Conversation Settings
Control key aspects of the personality's interaction during a conversation.

- **Auto Interrupt**: Toggle this setting ON/OFF to allow or prevent the personality from automatically interrupting the conversation when required.
- **Alerts**: Enable or disable alert notifications for the personality's activities.
...
### Behavior Controls
Define the behavior and purpose of the personality by configuring its prompts and starting messages.

- **Starting Message**: Customize the greeting or initial message that the personality uses to begin conversations.  

- **Description Prompt**: Provide a detailed description of the personality's traits and behavior.  

- **Purpose Prompt**: Specify the purpose or role of the personality in the interaction.  
...
### Identity Controls
Modify the voice and language of the personality for a more customized interaction.

- **Personality Voice**: Select a voice for the personality from the dropdown menu.  
 
- **Personality Language**: Choose the language the personality uses for conversations.  
...
These settings allow users to dynamically update the personality during a live conversation. Any changes made in the **Behavior Controls** or **Identity Controls** are reflected immediately, ensuring seamless adaptability during interactions.


### OpenHome API Key

You can find your API key under **Profile > Settings > API Keys**.. This key is crucial for authenticating with the OpenHome platform and linking your activities with the system.
...
<p align="center">
  <img src="openhome_icons/dashboard_icons/my_conversation_bar.png" alt="my_personalities_bar" />
</p>


### Conversation History

- Your conversation history is available on the center. This allows you to review previous interactions and see how a Personality has responded in past conversations, providing context for ongoing interactions.
