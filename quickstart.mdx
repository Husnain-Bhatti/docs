---
title: 'Quickstart'
description: 'Welcome to the OpenHome Dashboard! This guide will walk you through the essential steps to get started with your OpenHome experience. From logging in and navigating the dashboard to managing personalities and capabilities, this guide provides clear instructions to help you make the most of OpenHome’s powerful features. Whether you're a new user or just need a refresher, follow along to quickly familiarize yourself with the platform and start interacting with your AI personalities efficiently.'
---
