...
This guide will walk you through the process of setting up OpenHome on a Raspberry Pi Zero 2W. Follow the steps below to download the necessary software, burn the image to an SD card, and configure your device to work with OpenHome.
...
3. **Choose Device**:
   ...
   ![Choose Device Screenshot](/path/to/choose-device-screenshot.png) <!-- Add screenshot path -->

4. **Choose Operating System**:
   - Click on **"Choose Operating System"**.
   - Select **"Use custom"** and then choose the downloaded OpenHome image file.

   ![Choose OS Screenshot](/path/to/choose-os-screenshot.png) <!-- Add screenshot path -->

5. **Choose Storage**:
   - Click on **"Choose Storage"** and select your SD card from the list.

   ![Choose Storage Screenshot](/path/to/choose-storage-screenshot.png) <!-- Add screenshot path -->
...
1. **Access Profile Settings**:
   ...
   ![DevKit Screenshot](/path/to/devkit-screenshot.png) <!-- Add screenshot path -->
...
For further assistance, refer to the [OpenHome Documentation](https://docs.openhome.xyz) or contact support.

---

**Note**: Replace `/path/to/screenshot.png` with the actual paths to your screenshots for each step.
